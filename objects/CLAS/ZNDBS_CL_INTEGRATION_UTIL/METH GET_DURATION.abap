  METHOD get_duration.
    ...
    DATA(lv_instant_tstmp) = CONV yndbs_e_log_datetime( get_datetime_turkey( ) ).

    TRY.
        cl_abap_tstmp=>subtract( EXPORTING tstmp1 = lv_instant_tstmp
                                           tstmp2 = mv_begin_datetime
                                 RECEIVING r_secs = DATA(lv_seconds) ).
